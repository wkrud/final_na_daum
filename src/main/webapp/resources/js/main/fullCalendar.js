...
var calendar = $('#mini-cal').fullCalendar({
 ...
 /** ******************
  ...
  header                    : {
                                left   : 'prevYear, nextYear, today, viewWeekends',
			...
			success: function(response) {
				...
				for (var i = 0; i < eventList.length; i++) {
					...
					var evt = {
						...
						start: eventList[i].startDate,
						end: eventList[i].endDate,
						type: eventList[i].type,
						username: eventList[i].id,
						backgroundColor: eventList[i].backgroundColor,
						textColor: eventList[i].textColor,
						borderColor: eventList[i].borderColor,
