...
<!-- 사용자작성 css -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/audiobook/abstyle.css" />
	...
	<div id="container">
		<header>
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							<li class="nav-item"><a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/audiobook/search/list">검색하기</a></li>
							<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/audiobook/recommend/list">추천</a></li>
					...
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<sec:authorize access="isAnonymous()">
								<a class="dropdown-item" href="${pageContext.request.contextPath}/">메인</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/member/memberLogin.do">일기</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/member/memberLogin.do">가계부</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/member/memberLogin.do">캘린더</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/culture/board/1">전시정보</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/movie/movieList.do">영화</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/riot/riotheader.do">롤전적</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/audiobook/">오디오북</a>
				...
				<ul class="navbar-nav justify-content-end">
					<li class="nav-item">
						<div class="form-check pl-0 toggle darkmode">
							<input id="switch" type="checkbox" name="theme" class="darkmode"> <label for="switch" class="dk-tg">Toggle</label>
						</div>
					</li>
				</ul>
				<ul class="navbar-nav justify-content-end">
				...
				<sec:authorize access="isAuthenticated()">
					<button id="profile" type="button" class="btn btn-primary position-relative bg-light border-light rounded-circle" onclick="location.href='${pageContext.request.contextPath}/main/main.do'">
				...
				<ul class="navbar-nav justify-content-end">
					<li class="nav-item">
						<a class="dropdown-item" href="${pageContext.request.contextPath}/audiobook/album/enroll/list">앨범관리</a>
					</li>
				</ul>
				</sec:authorize>
