	...
	<div class="col-4 sub-menu">
		<table class="table">
			<thead class="thead-dark">
				<tr>
					<th scope="col">Gramophone${album.provider}</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="al-creator "><p class="al-creator">조 성 진 ${album.creator}</p></td>
				</tr>
				<tr>
					<td><p class="al-tp">- 예술의전당 리사이틀 공연 ${album.title}</p></td>
				</tr>
				<tr>
		...
		<table class="table" id="track-list">
			<tbody>
				<tr>
					...
					<td><img
						src="https://newsimg.sedaily.com/2016/11/16/1L3ZQUQWVY_4.jpg"
				...
				<tr>
					...
					<td><img
						src="https://newsimg.sedaily.com/2016/11/16/1L3ZQUQWVY_4.jpg"
						alt="..." class="img-thumbnail"></td>
					<td style="vertical-align: middle;"><span class="">쇼팽 스케르초 2번​</span></td>
					<td><img class="play-icon"
						src="${pageContext.request.contextPath}/resources/images/audiobook/play.png"
						id="play"></td>
					<td style="vertical-align: middle;"> <span class="">23:45  ${album.time_stamp[5]}</span></td>
