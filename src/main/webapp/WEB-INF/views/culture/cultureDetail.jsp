			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					...
					<div class="form-group row">
						<label for="date" class="col-sm-2 col-form-label">시작 날짜 : </label>
						<div class="col-sm-10">
							<input type="text" class="form-control- movie-detail"
					...
					<div class="form-group row">
						<label for="date" class="col-sm-2 col-form-label">종료 날짜 : </label>
						<div class="col-sm-10">
							<input type="text" class="form-control- movie-detail"
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control- movie-detail"
								name="genreNm" title="장르" id="genreNm" value="${culture.realmName}"
								readonly>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control- movie-detail"
								...
								value="${culture.prlaceAddr}" readonly>
						</div>
					</div>
		...
		<c:if test="${ loginMember.id != null }">
			...
			<form id="likeFrm">
				...
				<input type="hidden" name="id" value="${loginMember.id}" />
			 	<button type="submit" class="btn btn-success" id="like-btn" >스크랩<i class="fas fa-check-double ml-1"></i>
			 	</button>
			</form>		
		</c:if>
